...
public class DeckCardViewUIToolkit : IDeckCardView
{
    ...
    public DeckCardViewUIToolkit(CardModel model, VisualTreeAsset template)
    {
        cardModel = model;
    ...
    private void SetBodyAndBorders()
    {
        ...
        if (cardModel.secondaryElement != null)
        {
            ...
            elementsArea.style.width = new StyleLength(70);
            elementsArea.style.height = new StyleLength(30);
            elementsArea.style.left = new StyleLength(195);
            elementsArea.style.top = new StyleLength(235);

            cardRoot.Q<VisualElement>("mainElement").style.left = new StyleLength(13);
            cardRoot.Q<VisualElement>("mainElement").style.top = new StyleLength(4);
            cardRoot.Q<VisualElement>("secondaryElement").style.left = new StyleLength(41);
        ...
        else
        {
            ...
            elementsArea.style.width = new StyleLength(58);
            elementsArea.style.height = new StyleLength(30);
            elementsArea.style.left = new StyleLength(207);
            elementsArea.style.top = new StyleLength(235);
