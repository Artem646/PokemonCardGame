...
public class BelchAnimation : BaseAttackAnimation
{
    private GameObject belchPrefab;

    public BelchAnimation()
    {
        belchPrefab = Resources.Load<GameObject>("VFX/Belch");
    }
    ...
    public override IEnumerator PlayAnimation(BattleCardController attacker, BattleCardController defender, AttackManager attackManager, Action<Vector3, int> showDamagePopupCallback)
    {
        ...
        GameObject belchObject = UnityEngine.Object.Instantiate(belchPrefab, attackerCardTransform);
